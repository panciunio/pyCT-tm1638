...
# A library for controlling TM1638 displays from a Cubietruck/Cubieboard
# Based on code from https://github.com/johnblackmore/py-tm1638 - library wrote for Raspberry Pi
...
# This library requiring modules from: http://docs.cubieboard.org/tutorials/common/using_python_program_control_gpios
# http://dl.cubieboard.org/software/libs/pySUNXI-0.1.12.tar.gz

# This library need some modyfications into script.fex (scrip.bin) file cause of use PG0-PG4 GPIO.
# More info on page: https://cubietruck.pl
